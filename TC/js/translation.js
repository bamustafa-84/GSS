...
const translations = {
  fr: {
    ...
    evalColApprec: 'Appréciation',
    evalColObs: 'Observations',
    evalBtnAddRow: 'Ajouter un module',
    evalBtnRemove: 'Supprimer',
    evalSecSummary: 'RÉSUMÉ',
    evalLbTotalMax: 'Total max',
    evalLbTotalObt: 'Total obtenu',
    evalLbMoyenne: 'Moyenne (%)',
    evalLbApprecGen: 'Appréciation générale',
    evalSecResult: 'RÉSULTAT FINAL',
    evalLbResultat: "Résultat de l'évaluation",
    evalOptAdmis: ' Admis(e)',
    evalOptAjourne: ' Ajourné(e)',
    evalOptRefuse: ' Refusé(e)',
    ...
    evalDefaultModules: [
      'Législation et réglementation sécuritaire',
      'Techniques de surveillance et de ronde',
      "Contrôle d'accès et fouille",
      "Gestion des situations d'urgence",
      'Secourisme (Premiers secours)',
      'Communication et rédaction de rapports',
      'Discipline, attitude et comportement professionnel'
    ],
    evalApprecTB: 'TB — Très Bien',
    evalApprecB: 'B — Bien',
    evalApprecAB: 'AB — Assez Bien',
    evalApprecI: 'I — Insuffisant',
  ...
  en: {
    ...
    evalColApprec: 'Appreciation',
    evalColObs: 'Observations',
    evalBtnAddRow: 'Add module',
    evalBtnRemove: 'Remove',
    evalSecSummary: 'SUMMARY',
    evalLbTotalMax: 'Total max',
    evalLbTotalObt: 'Total obtained',
    evalLbMoyenne: 'Average (%)',
    evalLbApprecGen: 'Overall Appreciation',
    evalSecResult: 'FINAL RESULT',
    evalLbResultat: 'Evaluation Result',
    evalOptAdmis: ' Passed',
    evalOptAjourne: ' Deferred',
    evalOptRefuse: ' Failed',
    ...
    evalDefaultModules: [
      ...
      'Discipline, Attitude and Professional Conduct'
    ],
    evalApprecTB: 'TB — Very Good',
    evalApprecB: 'B — Good',
    evalApprecAB: 'AB — Fair',
    evalApprecI: 'I — Insufficient',
