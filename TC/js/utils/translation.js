...
const translations = {
  fr: {
    ...
    psTitle: 'Rechercher', psAllPanels: 'Tous les panneaux', psSearchPlaceholder: 'Rechercher un dossier…', noPanelFound: 'Aucun résultat',
    psGrid: 'Grille', psGridTitle: 'Panneaux et filtres', psGridExport: 'Exporter vers Excel', psGridExpandAll: 'Tout développer', psGridCollapseAll: 'Tout réduire', psSortHint: 'Cliquer pour trier',
    ...
    psGridUngrouped: 'Aucune formation assignée',
    psGridAllCourses: 'Toutes les formations', psGridAllYears: 'Toutes les années',
    psGridTotal: 'Total',
    psGridLoaded: 'chargés', psGridLoadMore: 'Charger plus',
    psGridTo: 'à',
    ...
    gcExamResult: 'Résultat examen', gcExamScore: 'Score total obtenu', gcFinalDecision: 'Décision finale', gcExamPass: 'Réussi', gcExamFail: 'Échec',
    gcExamStatus: 'Statut examen', examStWaitingYou: 'En attente de votre correction', examStWaiting: 'En attente de correction', examStCorrecting: 'Correction en cours', examStCorrected: 'Corrigé', examStInProgress: 'En cours', examStNone: 'Non commencé',
    gGrpPersonal: 'Informations personnelles', gGrpEducation: 'Niveau d\'études et expérience', gGrpHealth: 'État de santé', gGrpFees: 'Frais d\'inscription', gGrpAdmin: 'Administration', gGrpExam: 'Résultat d\'examen',
    // ── Signature manager ────────────────────────────────────
    ...
    confirmPresences: 'Êtes-vous sûr de vouloir confirmer les informations de présence ?',
    engErrIdRequired: 'Veuillez saisir le numéro de carte d\'identité / passeport avant d\'accepter.',
    examErrRequired: 'Veuillez renseigner la Note, le Résultat et la Décision avant de valider l\'examen.',
    examSigMissing: 'Aucune signature n\'est enregistrée pour votre compte. Ajoutez votre signature dans le panneau Signatures pour qu\'elle soit appliquée automatiquement.',
    dossierAckRole: 'Vous n\'êtes pas autorisé à certifier ce dossier du candidat.',
    dossierAckIncomplete: 'Une ou plusieurs cases obligatoires ne sont pas encore cochées.',
    dossierAckDone: 'Ce dossier du candidat a déjà été certifié.',
    dossierAckConfirm: 'Êtes-vous sûr de vouloir certifier ce Dossier Individuel du Candidat ? Cette action sera enregistrée.',
    evalStComplete: 'Évaluation terminée — validée par le Formateur et l\'Admin.',
    evalStInstructor: 'Veuillez compléter les notes et cocher la reconnaissance pour signer en tant que Formateur.',
    evalStWaitInstructor: 'En attente que le Formateur complète et signe l\'évaluation.',
    evalStAdmin: 'Le Formateur a signé. Définissez le Résultat Final et cochez la reconnaissance pour finaliser.',
    evalStWaitAdmin: 'Le Formateur a signé. En attente que l\'Admin définisse le Résultat Final et finalise.',
    evalErrAdminOnly: 'Seul un Admin peut définir le Résultat Final et finaliser l\'évaluation.',
    evalErrFinalRequired: 'Veuillez sélectionner le Résultat Final avant de finaliser l\'évaluation.',
    evalConfirmAdmin: 'Finaliser cette évaluation ? Cette action sera enregistrée.',
    evalErrInstructorOnly: 'Seul le Formateur peut compléter et signer l\'évaluation.',
    evalErrGradesRequired: 'Veuillez renseigner toutes les notes avant de signer l\'évaluation.',
    evalConfirmInstructor: 'Signer cette évaluation en tant que Formateur ? Les notes seront verrouillées et enregistrées.',
    psColEdit: 'Modifier',
    psColExpand: 'Développer',
    psColDelete: 'Supprimer',
    psColPrint: 'Imprimer',
    psDeleteConfirm: 'Supprimer ce candidat et toutes ses données ? Cette action est irréversible.',
    psDeleteError: 'Impossible de supprimer le candidat.',
    dictManage: 'Gestion du dictionnaire', dictTitle: 'Gestion du dictionnaire', dictEduTitle: 'Niveaux d\'études',
    dictTrainingTitle: 'Intitulés de formation', dictTrainerTitle: 'Formateurs',
    optSelectTrainingTitle: 'Sélectionner un intitulé de formation', optSelectTrainer: 'Sélectionner un formateur',
    trainingTitleSafety: 'Formation en sécurité',
    attSheetBtn: 'Feuille de présence', attSheetTitle: 'Présence mensuelle · feuille de pointage',
    attSheetColName: 'Nom', attSheetColNo: 'N°', attSheetPresent: 'coche = présent', attSheetDays: 'jours',
    attSheetClear: 'Effacer les coches', attSheetSave: 'Enregistrer', attSheetSaved: 'Enregistré ✓', attSheetViewOnly: 'Lecture seule',
    attSheetExport: 'Exporter vers Excel',
    attSheetExportCourse: 'Formation', attSheetExportMonth: 'Mois', attSheetExportLegend: 'Légende',
    attSheetNoTitles: 'Aucun intitulé de formation ne vous est encore attribué.',
    attSheetSelectAllDay: 'Cocher/décocher tous les stagiaires pour ce jour',
    attSheetOutsideRange: 'Hors de la période de formation',
    attSheetInstructor: 'Formateur',
    examBtn: 'Examens', examTitle: 'Configuration de l\'examen', examCourse: 'Formation', examPickCourse: 'Choisir une formation…',
    // ── Exam publishing / credentials / correction / portal ──
    examDateLabel: 'Date d\'examen *', examDurationLabel: 'Durée (min)', examPassingLabel: 'Note de passage', examStatusLabel: 'Statut',
    examStatusDraft: 'BROUILLON', examStatusPublished: 'PUBLIÉ', examPublish: 'Publier l\'examen', examRepublish: 'Mettre à jour et republier',
    examConfigTitle: 'Configuration de l\'examen',
    examPanelNone: 'Ce candidat n\'a pas encore passé d\'examen.',
    examPanelInProgress: 'Le candidat passe actuellement l\'examen. Le résultat apparaîtra ici une fois soumis et corrigé.',
    examPanelWaiting: 'Le candidat a terminé l\'examen. Il est en attente de correction — le résultat apparaîtra ici une fois corrigé.',
    stepInProgress: 'En cours — étape non encore atteinte pour ce candidat.',
    examPanelCorrected: 'Examen terminé et corrigé', examPanelPass: 'RÉUSSI', examPanelFail: 'ÉCHEC', examPanelPassMark: 'note de passage',
    examPanelCorrectNow: 'Corriger cet examen maintenant →', examQuickHint: 'Verrouillé — survolez pour définir le statut de l\'examen',
    examCredentialsBtn: 'Identifiants', examCredsBtn: 'Identifiants', examNeedDate: 'Saisissez une date d\'examen valide avant de publier.',
    examPublishing: 'Publication et génération des comptes d\'examen…', examPublished: 'Examen publié ✓ Comptes temporaires générés : ',
    ...
    credStarted: 'Débuté', credSubmitted: 'Soumis', credScore: 'Note', credResult: 'Résultat', credActions: 'Actions',
    credView: 'Voir', credCopyUser: 'Copier l\'identifiant', credCopyUserShort: 'Copier id', credCopyPw: 'Copier', credSend: 'Envoyer',
    credDisable: 'Désactiver', credCorrect: 'Corriger', credViewAnswers: 'Voir les réponses', credCopiedUser: 'Identifiant copié ✓',
    credSending: 'Préparation du message…', credSendErr: 'Impossible de préparer l\'identifiant.', credSendTitle: 'Envoyer l\'identifiant',
    credSendHint: 'Un message prêt à envoyer a été préparé. Copiez-le et envoyez-le au candidat par votre canal habituel.', credCopyMsg: 'Copier le message',
    credConfirmDisable: 'Désactiver cet identifiant d\'examen ? Le candidat ne pourra plus se connecter. L\'historique est conservé.',
    credDisabled: 'Identifiant désactivé ✓', credDisableErr: 'Impossible de désactiver l\'identifiant.', credPwUnavailable: 'Indisponible — republiez pour régénérer.',
    credSecurity: 'Ne partagez les identifiants qu\'avec le candidat concerné.',
    credGenerate: 'Générer', credGenerating: 'Génération de l\'identifiant…', credGenerated: 'Identifiant généré ✓', credGenerateErr: 'Impossible de générer l\'identifiant.',
    correctTitle: 'Corriger l\'examen', correctSaveDraft: 'Enregistrer', correctFinalize: 'Terminer la correction', correctReFinalize: 'Mettre à jour le résultat',
    correctLoading: 'Chargement de l\'examen soumis…', correctLoadErr: 'Impossible de charger l\'examen soumis.', correctNoAnswer: 'Aucune réponse fournie.',
    correctCandidateAnswer: 'Réponse du candidat', correctPoints: 'Points', correctCommentPlaceholder: 'Commentaire / observation facultatif pour le candidat…',
    correctTotal: 'Total', correctExpected: 'attendu', correctChosen: 'candidat', correctCandidateOrder: 'Ordre du candidat', correctCorrectOrder: 'Ordre correct',
    correctCandidate: 'Candidat', correctExam: 'Examen', correctInstructor: 'Formateur', correctSubmitted: 'Soumis', correctPassMark: 'Note de passage', correctStatus: 'Statut',
    correctAuto: 'auto', correctWrong: 'auto', correctSaving: 'Enregistrement…', correctFinalizing: 'Finalisation…', correctSaved: 'Progression enregistrée ✓',
    correctDone: 'Correction terminée ✓ Le résultat est disponible pour le candidat.', correctErr: 'Impossible d\'enregistrer la correction.',
    correctConfirmFinalize: 'Terminer la correction et publier le résultat au candidat ?',
    loginHaveExam: 'Vous avez des identifiants d\'examen ?', loginTakeExam: 'Passer un examen',
    examLibrary: 'Banque de questions', examConfig: 'Questions de l\'examen',
    examTypeMC: 'Choix multiple', examTypeText: 'Réponse texte',
    examSelectFirst: 'Veuillez sélectionner une formation pour charger ses questions.',
    examNoQuestions: 'Aucune question disponible pour cette formation.',
    examLoadError: 'Impossible de charger les questions. Le serveur est-il démarré ?',
    examDropHint: 'Glissez-déposez des questions ici pour configurer l\'examen.',
    examAdded: 'Dans l\'examen', examRemove: 'Retirer', examReorder: 'Glisser pour réordonner',
    examCorrect: 'Correct', examAnswerPlaceholder: 'Réponse du stagiaire…',
    examCancel: 'Annuler', examSave: 'Enregistrer la configuration',
    examErrEmpty: 'Ajoutez au moins une question avant d\'enregistrer.',
    examSaved: 'Configuration de l\'examen enregistrée ✓', examErrSave: 'Impossible d\'enregistrer la configuration de l\'examen.',
    examNewQuestion: '+ Nouvelle question', examNewQuestionTitle: 'Nouvelle question', examEditQuestion: 'Modifier la question',
    examPreview: 'Aperçu candidat', examPreviewTitle: 'Aperçu candidat',
    examPreviewBanner: 'Mode aperçu — voici l\'examen tel que le voit un candidat. Les réponses ne seront pas enregistrées.',
    examPreviewFinish: 'Terminer l\'aperçu', examPreviewDone: 'Aperçu terminé — aucune réponse enregistrée.',
    examPreviewNone: 'Cette formation n\'a pas encore d\'examen configuré à prévisualiser.', examPreviewUnavailable: 'L\'aperçu est indisponible.',
    examInstructor: 'Formateur', examTakeInstructor: 'Formateur', examTakeCourse: 'Formation',
    examInstructionsLabel: 'Consignes de l\'examen (visibles par les candidats)',
    examInstructionsPlaceholder: 'ex. Lisez attentivement chaque question. Répondez à toutes les questions.',
    examAddToExam: 'Ajouter à l\'examen', examEdit: 'Modifier', examDelete: 'Supprimer',
    examType: 'Type de question', examRequired: 'Obligatoire', examGrade: 'Points',
    examImage: 'Image (optionnelle)', examRemoveImage: 'Supprimer l\'image', examImageTooBig: 'L\'image doit faire moins de 2 Mo.',
    examAddOption: 'Ajouter une option', examRemoveOption: 'Supprimer', examCreate: 'Créer la question', examApply: 'Enregistrer la question', examSaving: 'Enregistrement…',
    examQuestionText: 'Texte de la question', examQuestionPlaceholder: 'Saisissez la question…',
    examOptionPlaceholder: 'Option de réponse', examStepPlaceholder: 'Étape / élément', examMatchLeft: 'Élément', examMatchRight: 'Correspondance',
    examAnswers: 'Réponses', examTrue: 'Vrai', examFalse: 'Faux',
    examCreated: 'Question créée ✓', examUpdated: 'Question mise à jour ✓', examDeleted: 'Question supprimée ✓',
    examDeleteTitle: 'Supprimer la question', examDeleteMsg: 'Cette action supprime définitivement la question de cette formation. Irréversible.',
    examDeleteErr: 'Impossible de supprimer la question.',
    examErrText: 'Veuillez saisir le texte de la question.', examErrOptions: 'Indiquez au moins deux options de réponse.',
    examErrCorrect: 'Sélectionnez la bonne réponse.', examErrMatch: 'Indiquez au moins deux paires de correspondance complètes.',
    examErrOrder: 'Indiquez au moins deux éléments à ordonner.', examErrSaveQ: 'Impossible d\'enregistrer la question.',
    type_MULTIPLE_CHOICE: 'Choix multiple', type_TRUE_FALSE: 'Vrai / Faux', type_MATCH_ITEMS: 'Associations',
    type_CHRONOLOGICAL_ORDERING: 'Ordonnancement', type_DEFINITION: 'Définition', type_ANALYTICAL: 'Analytique',
    attSheetCompleted: 'Formation terminée',
    attSheetYear: 'Année',
    attSheetPickMonth: 'Sélectionnez un mois :',
    attSheetNoCoursesMonth: 'Aucune formation programmée pour ce mois.',
    attSheetLegendActive: 'En cours', attSheetLegendDone: 'Terminé', attSheetLegendNone: 'Aucune formation',
    attSheetLegendTitle: 'Statut',
    attSheetLegendAH: 'À l\'heure (AH)', attSheetLegendAR: 'En retard (AR)', attSheetLegendABS: 'Absent (ABS)', attSheetLegendEX: 'Exclu (EX)',
    attCellTitle: 'Modifier la présence', attCellStatus: 'Statut',
    attCellStatusAH: 'AH – À l\'heure', attCellStatusAR: 'AR – En retard', attCellStatusABS: 'ABS – Absent', attCellStatusEX: 'EX – Exclu',
    attCellArrival: 'Heure d\'arrivée', attCellDeparture: 'Heure de départ', attCellObservation: 'Observation',
    attCellSave: 'Enregistrer', attCellCancel: 'Annuler', attCellReset: 'Réinitialiser',
    presTrainingTitleRequired: 'Veuillez d\'abord sélectionner un intitulé de formation.',
    presDatesRequired: 'Veuillez d\'abord renseigner les dates Du et Au de la formation.',
    presTrainingSaveError: 'Impossible d\'enregistrer la formation. Le serveur est-il démarré ?',
    presTrainingConflict: 'Une formation portant ce titre existe déjà avec un autre calendrier. Utilisez un titre distinct pour une session ayant des dates/heures différentes.',
    ...
    roleAdmin: 'Administrateur', roleHeadOfTraining: 'Responsable de formation', roleSecretary: 'Secrétaire', roleCandidate: 'Candidat', roleInstructor: 'Instructeur',
    usersBtn: 'Utilisateurs', usersTitle: 'Gestion des utilisateurs', usersAdd: 'Ajouter un utilisateur', usersUsername: 'Nom d’utilisateur', usersFullName: 'Nom complet', usersRole: 'Rôle', usersPassword: 'Mot de passe', usersActive: 'Compte activé',
    usersNone: 'Aucun utilisateur trouvé.', usersStatusCol: 'Statut', usersActions: 'Actions', usersEnabled: 'Activé', usersDisabled: 'Désactivé', usersEnable: 'Activer', usersDisable: 'Désactiver',
    usersSavedOk: 'Utilisateur enregistré.', usersLoadErr: 'Impossible de charger les utilisateurs. Le serveur est-il démarré ?', usersErrExists: 'Ce nom d’utilisateur est déjà pris.', usersErrSave: 'Impossible d’enregistrer l’utilisateur.', usersErrUsername: 'Un nom d’utilisateur est requis.', usersErrPw: 'Le mot de passe doit comporter au moins 8 caractères.',
    ...
    measErrRequired: 'Veuillez remplir tous les champs obligatoires avant de confirmer la Fiche de Mensuration.',
    measConfirm: 'Êtes-vous sûr de vouloir confirmer la Fiche de Mensuration ? Les champs seront verrouillés et enregistrés.',
    measSaveError: "La Fiche de Mensuration n'a pas pu être enregistrée. Veuillez réessayer.",
  ...
  en: {
    ...
    psTitle: 'Find in form', psAllPanels: 'All panels', psSearchPlaceholder: 'Search records…', noPanelFound: 'No results found',
    psGrid: 'Grid', psGridTitle: 'Panels & filters', psGridExport: 'Export to Excel', psGridExpandAll: 'Expand all', psGridCollapseAll: 'Collapse all', psSortHint: 'Click to sort',
    ...
    psGridUngrouped: 'No training assigned',
    psGridAllCourses: 'All courses', psGridAllYears: 'All years',
    psGridTotal: 'Total',
    psGridLoaded: 'loaded', psGridLoadMore: 'Load more',
    psGridTo: 'to',
    ...
    gcExamResult: 'Exam Result', gcExamScore: 'Total Score Obtained', gcFinalDecision: 'Final Decision', gcExamPass: 'Pass', gcExamFail: 'Failed',
    gcExamStatus: 'Exam Status', examStWaitingYou: 'Waiting for your correction', examStWaiting: 'Waiting for correction', examStCorrecting: 'Correcting', examStCorrected: 'Corrected', examStInProgress: 'In progress', examStNone: 'Not started',
    gGrpPersonal: 'Personal Information', gGrpEducation: 'Education & Experience', gGrpHealth: 'Health Status', gGrpFees: 'Registration Fees', gGrpAdmin: 'Administration', gGrpExam: 'Exam Result',
    // ── Signature manager ────────────────────────────────────
    ...
    confirmPresences: 'Are you sure you want to confirm the attendance information?',
    engErrIdRequired: 'Please enter the ID Card / Passport Number before accepting.',
    examErrRequired: 'Please provide the Score, Result and Decision before acknowledging the exam.',
    examSigMissing: 'No signature is on file for your account. Add your signature in the Signatures panel so it can be applied automatically.',
    dossierAckRole: 'You are not authorised to certify this candidate file.',
    dossierAckIncomplete: 'One or more required checklist documents are not yet checked.',
    dossierAckDone: 'This candidate file has already been certified.',
    dossierAckConfirm: 'Are you sure you want to certify this Individual Candidate File? This will be saved.',
    evalStComplete: 'Evaluation complete — validated by the Instructor and the Admin.',
    evalStInstructor: 'Please complete the grades and check the acknowledgement to sign as Instructor.',
    evalStWaitInstructor: 'Waiting for the Instructor to complete and sign the evaluation.',
    evalStAdmin: 'The Instructor has signed. Set the Final Result and check the acknowledgement to finalise.',
    evalStWaitAdmin: 'The Instructor has signed. Waiting for the Admin to set the Final Result and finalise.',
    evalErrAdminOnly: 'Only an Admin can set the Final Result and finalise the evaluation.',
    evalErrFinalRequired: 'Please select the Final Result before finalising the evaluation.',
    evalConfirmAdmin: 'Finalise this evaluation? This will be saved.',
    evalErrInstructorOnly: 'Only the Instructor can complete and sign the evaluation.',
    evalErrGradesRequired: 'Please fill in every grade before signing the evaluation.',
    evalConfirmInstructor: 'Sign this evaluation as Instructor? The grades will be locked and saved.',
    psColEdit: 'Edit',
    psColExpand: 'Expand',
    psColDelete: 'Delete',
    psColPrint: 'Print',
    psDeleteConfirm: 'Delete this candidate and all their records? This cannot be undone.',
    psDeleteError: 'Could not delete the candidate.',
    dictManage: 'Dictionary Management', dictTitle: 'Dictionary Management', dictEduTitle: 'Education Levels',
    dictTrainingTitle: 'Training Titles', dictTrainerTitle: 'Trainers',
    optSelectTrainingTitle: 'Select a training title', optSelectTrainer: 'Select a trainer',
    trainingTitleSafety: 'Safety Training',
    attSheetBtn: 'Attendance sheet', attSheetTitle: 'Monthly attendance · tick sheet',
    attSheetColName: 'Name', attSheetColNo: 'No.', attSheetPresent: 'tick = present', attSheetDays: 'days',
    attSheetClear: 'Clear all ticks', attSheetSave: 'Save', attSheetSaved: 'Saved ✓', attSheetViewOnly: 'View only',
    attSheetExport: 'Export to Excel',
    attSheetExportCourse: 'Course', attSheetExportMonth: 'Month', attSheetExportLegend: 'Legend',
    attSheetNoTitles: 'No training titles are assigned to you yet.',
    attSheetSelectAllDay: 'Select/deselect all students for this day',
    attSheetOutsideRange: 'Outside the training date range',
    attSheetInstructor: 'Instructor',
    examBtn: 'Exams', examTitle: 'Exam configuration', examCourse: 'Training course', examPickCourse: 'Select a course…',
    // ── Exam publishing / credentials / correction / portal ──
    examDateLabel: 'Exam date *', examDurationLabel: 'Duration (min)', examPassingLabel: 'Pass mark', examStatusLabel: 'Status',
    examStatusDraft: 'DRAFT', examStatusPublished: 'PUBLISHED', examPublish: 'Publish exam', examRepublish: 'Update & re-publish',
    examConfigTitle: 'Exam configuration',
    examPanelNone: 'This candidate has not taken an exam yet.',
    examPanelInProgress: 'The candidate is currently taking the exam. The result will appear here once it is submitted and corrected.',
    examPanelWaiting: 'The candidate has finished the exam. It is awaiting correction — the result will appear here once corrected.',
    stepInProgress: 'In progress — this step has not been reached for this candidate yet.',
    examPanelCorrected: 'Exam completed and corrected', examPanelPass: 'PASS', examPanelFail: 'FAIL', examPanelPassMark: 'pass mark',
    examPanelCorrectNow: 'Correct this exam now →', examQuickHint: 'Locked — hover to set the exam status',
    examCredentialsBtn: 'Credentials', examCredsBtn: 'Credentials', examNeedDate: 'Enter a valid exam date before publishing.',
    examPublishing: 'Publishing and generating exam accounts…', examPublished: 'Exam published ✓ Temporary accounts generated: ',
    ...
    credStarted: 'Started', credSubmitted: 'Submitted', credScore: 'Score', credResult: 'Result', credActions: 'Actions',
    credView: 'View', credCopyUser: 'Copy username', credCopyUserShort: 'Copy user', credCopyPw: 'Copy', credSend: 'Send',
    credDisable: 'Disable', credCorrect: 'Correct', credViewAnswers: 'View answers', credCopiedUser: 'Username copied ✓',
    credSending: 'Preparing message…', credSendErr: 'Could not prepare the credential.', credSendTitle: 'Send credential',
    credSendHint: 'A ready-to-send message has been prepared. Copy it and send it to the candidate through your usual channel (email / SMS / print).', credCopyMsg: 'Copy message',
    credConfirmDisable: 'Disable this exam credential? The candidate will no longer be able to sign in. Exam history is preserved.',
    credDisabled: 'Credential disabled ✓', credDisableErr: 'Could not disable the credential.', credPwUnavailable: 'Unavailable — regenerate by re-publishing.',
    credSecurity: 'Only share credentials with the intended candidate.',
    credGenerate: 'Generate', credGenerating: 'Generating credential…', credGenerated: 'Credential generated ✓', credGenerateErr: 'Could not generate the credential.',
    correctTitle: 'Correct exam', correctSaveDraft: 'Save progress', correctFinalize: 'Finish correction', correctReFinalize: 'Update result',
    correctLoading: 'Loading submitted exam…', correctLoadErr: 'Could not load the submitted exam.', correctNoAnswer: 'No answer provided.',
    correctCandidateAnswer: 'Candidate answer', correctPoints: 'Points', correctCommentPlaceholder: 'Optional comment / observation for the candidate…',
    correctTotal: 'Total', correctExpected: 'expected', correctChosen: 'candidate', correctCandidateOrder: 'Candidate order', correctCorrectOrder: 'Correct order',
    correctCandidate: 'Candidate', correctExam: 'Exam', correctInstructor: 'Instructor', correctSubmitted: 'Submitted', correctPassMark: 'Pass mark', correctStatus: 'Status',
    correctAuto: 'auto', correctWrong: 'auto', correctSaving: 'Saving…', correctFinalizing: 'Finalizing…', correctSaved: 'Progress saved ✓',
    correctDone: 'Correction complete ✓ Result is now available to the candidate.', correctErr: 'Could not save the correction.',
    correctConfirmFinalize: 'Finish correction and publish the result to the candidate? This makes the Panel-Exam result available.',
    loginHaveExam: 'Have exam credentials?', loginTakeExam: 'Take an exam',
    examLibrary: 'Question library', examConfig: 'Exam questions',
    examTypeMC: 'Multiple choice', examTypeText: 'Text answer',
    examSelectFirst: 'Please select a training course to load its questions.',
    examNoQuestions: 'No questions are available for this training course.',
    examLoadError: 'Could not load questions. Is the server running?',
    examDropHint: 'Drag and drop questions here to configure the exam.',
    examAdded: 'In exam', examRemove: 'Remove', examReorder: 'Drag to reorder',
    examCorrect: 'Correct', examAnswerPlaceholder: 'Student answer…',
    examCancel: 'Cancel', examSave: 'Save configuration',
    examErrEmpty: 'Add at least one question before saving.',
    examSaved: 'Exam configuration saved ✓', examErrSave: 'Could not save the exam configuration.',
    examNewQuestion: '+ New question', examNewQuestionTitle: 'New question', examEditQuestion: 'Edit question',
    examPreview: 'Preview as candidate', examPreviewTitle: 'Preview as candidate',
    examPreviewBanner: 'Preview mode — this is how the exam looks to a candidate. Answers will not be saved.',
    examPreviewFinish: 'Finish preview', examPreviewDone: 'Preview finished — no answers were saved.',
    examPreviewNone: 'This training has no configured exam to preview yet.', examPreviewUnavailable: 'Preview is unavailable.',
    examInstructor: 'Instructor', examTakeInstructor: 'Instructor', examTakeCourse: 'Training',
    examInstructionsLabel: 'Exam instructions (shown to candidates)',
    examInstructionsPlaceholder: 'e.g. Read each question carefully. Answer all questions.',
    examAddToExam: 'Add to exam', examEdit: 'Edit', examDelete: 'Delete',
    examType: 'Question type', examRequired: 'Required', examGrade: 'Points',
    examImage: 'Image (optional)', examRemoveImage: 'Remove image', examImageTooBig: 'Image must be under 2 MB.',
    examAddOption: 'Add option', examRemoveOption: 'Remove', examCreate: 'Create question', examApply: 'Save question', examSaving: 'Saving…',
    examQuestionText: 'Question text', examQuestionPlaceholder: 'Enter the question…',
    examOptionPlaceholder: 'Answer option', examStepPlaceholder: 'Step / item', examMatchLeft: 'Item', examMatchRight: 'Match',
    examAnswers: 'Answers', examTrue: 'True', examFalse: 'False',
    examCreated: 'Question created ✓', examUpdated: 'Question updated ✓', examDeleted: 'Question deleted ✓',
    examDeleteTitle: 'Delete question', examDeleteMsg: 'This permanently deletes the question from this training. This cannot be undone.',
    examDeleteErr: 'Could not delete the question.',
    examErrText: 'Please enter the question text.', examErrOptions: 'Provide at least two answer options.',
    examErrCorrect: 'Select the correct answer.', examErrMatch: 'Provide at least two complete match pairs.',
    examErrOrder: 'Provide at least two items to order.', examErrSaveQ: 'Could not save the question.',
    type_MULTIPLE_CHOICE: 'Multiple choice', type_TRUE_FALSE: 'True / False', type_MATCH_ITEMS: 'Match items',
    type_CHRONOLOGICAL_ORDERING: 'Ordering', type_DEFINITION: 'Definition', type_ANALYTICAL: 'Analytical',
    attSheetCompleted: 'Completed course',
    attSheetYear: 'Year',
    attSheetPickMonth: 'Select a month:',
    attSheetNoCoursesMonth: 'No courses scheduled for this month.',
    attSheetLegendActive: 'Active', attSheetLegendDone: 'Completed', attSheetLegendNone: 'No course',
    attSheetLegendTitle: 'Status',
    attSheetLegendAH: 'On time (AH)', attSheetLegendAR: 'Late (AR)', attSheetLegendABS: 'Absent (ABS)', attSheetLegendEX: 'Excluded (EX)',
    attCellTitle: 'Edit attendance', attCellStatus: 'Status',
    attCellStatusAH: 'AH – On Time', attCellStatusAR: 'AR – Late', attCellStatusABS: 'ABS – Absent', attCellStatusEX: 'EX – Excluded',
    attCellArrival: 'Arrival Time', attCellDeparture: 'Departure Time', attCellObservation: 'Observation',
    attCellSave: 'Save', attCellCancel: 'Cancel', attCellReset: 'Reset',
    presTrainingTitleRequired: 'Please select a Training Title first.',
    presDatesRequired: 'Please provide the training From and To dates first.',
    presTrainingSaveError: 'Could not save the training. Is the server running?',
    presTrainingConflict: 'A course with this title already exists with a different schedule. Use a distinct title for a session with different dates/times.',
    ...
    roleAdmin: 'Admin', roleHeadOfTraining: 'Head of Training', roleSecretary: 'Secretary', roleCandidate: 'Candidate', roleInstructor: 'Instructor',
    usersBtn: 'Users', usersTitle: 'Manage Users', usersAdd: 'Add user', usersUsername: 'Username', usersFullName: 'Full name', usersRole: 'Role', usersPassword: 'Password', usersActive: 'Account enabled',
    usersNone: 'No users found.', usersStatusCol: 'Status', usersActions: 'Actions', usersEnabled: 'Enabled', usersDisabled: 'Disabled', usersEnable: 'Enable', usersDisable: 'Disable',
    usersSavedOk: 'User saved.', usersLoadErr: 'Could not load users. Is the server running?', usersErrExists: 'That username is already taken.', usersErrSave: 'Could not save the user.', usersErrUsername: 'A username is required.', usersErrPw: 'Password must be at least 8 characters.',
    ...
    measErrRequired: 'Please fill in every required field before confirming the Measurements Sheet.',
    measConfirm: 'Are you sure you want to confirm the Measurements Sheet? The fields will be locked and saved.',
    measSaveError: 'The Measurements Sheet could not be saved. Please try again.',
    ...
    dossierLbObs: 'Observations',
    dossierSec2: '1. DOCUMENT CHECKLIST',
    dossierColDoc: 'Document',
...
const loginTranslations = {
  en: {
    ...
    loginEmailLabel: 'Username',
    loginEmailPh: 'ZakiMustafa',
    ...
    errEmail: 'Invalid username.',
    signingIn: 'Signing in…',
    // ── Sign up modal ──
    signupTitle: 'Create your account',
    signupSubtitle: 'Fill in your details to get started with GSS.',
    signupNameLabel: 'Full name',
    signupNamePh: 'Zaki Mustafa',
    signupEmailLabel: 'Username',
    signupEmailPh: 'ZakiMustafa',
    ...
    signupErrUsername: 'Please enter a username.',
    ...
    signupErrExists: 'This username is already taken.',
    signupSuccess: 'Account created! You can now sign in.',
    // ── Authentication ──
    loginForceChange: 'Change password on first login',
    ...
    cpTitle: 'Change your password',
    cpSubtitle: 'For your security, please set a new password to continue.',
    cpCurrentLabel: 'Current password',
    cpNewLabel: 'New password',
    cpNewPh: 'At least 8 characters',
    cpConfirmLabel: 'Confirm new password',
    cpConfirmPh: 'Re-enter your new password',
    cpSubmit: 'Update password',
    cpErrRequired: 'Please fill in all fields.',
    cpErrShort: 'New password must be at least 8 characters.',
    cpErrMatch: 'The new passwords do not match.',
    cpErrSame: 'The new password must differ from the current one.',
    cpErrCurrent: 'Your current password is incorrect.',
    cpSuccess: 'Password updated. Redirecting…',
    // ── Forgot password ──
    fpTitle: 'Reset your password',
    fpSubtitle: 'Enter your username to receive a temporary password.',
    fpUsernameLabel: 'Username',
    fpSubmit: 'Send temporary password',
    fpResultTitle: 'Temporary password generated',
    fpResultHint: 'Use this temporary password to sign in. You will be asked to set a new password.',
    fpErrRequired: 'Please enter your username.',
    fpSent: 'If the account exists, a temporary password has been generated.',
    fpGoLogin: 'Continue to sign in',
    signupForceChange: 'Require password change on first login',
    signupRoleLabel: 'Role',
    roleCandidate: 'Candidate',
    roleAdmin: 'Admin',
    roleHeadOfTraining: 'Head of Training',
  ...
  fr: {
    ...
    loginEmailLabel: 'Nom d’utilisateur',
    loginEmailPh: 'ZakiMustafa',
    ...
    signupEmailLabel: 'Nom d’utilisateur',
    signupEmailPh: 'ZakiMustafa',
    ...
    signupErrUsername: 'Veuillez saisir un nom d’utilisateur.',
    ...
    signupErrExists: 'Ce nom d’utilisateur est déjà utilisé.',
    signupSuccess: 'Compte créé ! Vous pouvez maintenant vous connecter.',
    // ── Authentification ──
    loginForceChange: 'Changer le mot de passe à la première connexion',
    errInvalidCreds: 'Nom d’utilisateur ou mot de passe invalide.',
    errLocked: 'Compte verrouillé après trop de tentatives. Veuillez réessayer plus tard.',
    errInactive: 'Ce compte est inactif. Contactez un administrateur.',
    errServer: 'Impossible de contacter le serveur. Veuillez réessayer.',
    loginSuccess: 'Connexion réussie.',
    // ── Fenêtre de changement de mot de passe ──
    cpTitle: 'Changer votre mot de passe',
    cpSubtitle: 'Pour votre sécurité, veuillez définir un nouveau mot de passe pour continuer.',
    cpCurrentLabel: 'Mot de passe actuel',
    cpNewLabel: 'Nouveau mot de passe',
    cpNewPh: 'Au moins 8 caractères',
    cpConfirmLabel: 'Confirmer le nouveau mot de passe',
    cpConfirmPh: 'Ressaisissez votre nouveau mot de passe',
    cpSubmit: 'Mettre à jour',
    cpErrRequired: 'Veuillez remplir tous les champs.',
    cpErrShort: 'Le nouveau mot de passe doit comporter au moins 8 caractères.',
    cpErrMatch: 'Les nouveaux mots de passe ne correspondent pas.',
    cpErrSame: 'Le nouveau mot de passe doit être différent de l’actuel.',
    cpErrCurrent: 'Votre mot de passe actuel est incorrect.',
    cpSuccess: 'Mot de passe mis à jour. Redirection…',
    // ── Mot de passe oublié ──
    fpTitle: 'Réinitialiser votre mot de passe',
    fpSubtitle: 'Saisissez votre nom d’utilisateur pour recevoir un mot de passe temporaire.',
    fpUsernameLabel: 'Nom d’utilisateur',
    fpSubmit: 'Envoyer un mot de passe temporaire',
    fpResultTitle: 'Mot de passe temporaire généré',
    fpResultHint: 'Utilisez ce mot de passe temporaire pour vous connecter. Vous devrez définir un nouveau mot de passe.',
    fpErrRequired: 'Veuillez saisir votre nom d’utilisateur.',
    fpSent: 'Si le compte existe, un mot de passe temporaire a été généré.',
    fpGoLogin: 'Continuer vers la connexion',
    signupForceChange: 'Exiger le changement de mot de passe à la première connexion',
    signupRoleLabel: 'Rôle',
    roleCandidate: 'Candidat',
    roleAdmin: 'Administrateur',
    roleHeadOfTraining: 'Responsable de formation',
...
const REGISTRATION_MESSAGES = {
  fr: {
    ...
    remarksRequired: 'Veuillez saisir une remarque expliquant le rejet.',
    nameExists: 'Ce nom complet est déjà enregistré.',
  ...
  en: {
    ...
    remarksRequired: 'Please enter a remark explaining the rejection.',
    nameExists: 'This full name is already registered.',
