...
const translations = {
  fr: {
    ...
    evalConfirmAdmin: 'Finaliser cette évaluation et enregistrer la signature du Responsable / Directeur ? Cette action sera enregistrée.',
    ...
    attSheetColName: 'Nom', attSheetPresent: 'coche = présent', attSheetDays: 'jours',
    ...
    attCellSave: 'Enregistrer', attCellCancel: 'Annuler',
  ...
  en: {
    ...
    evalConfirmAdmin: 'Finalise this evaluation and record the Manager/Director signature? This will be saved.',
    ...
    attSheetColName: 'Name', attSheetPresent: 'tick = present', attSheetDays: 'days',
    ...
    attCellSave: 'Save', attCellCancel: 'Cancel',
